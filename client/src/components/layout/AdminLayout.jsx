      ...
      <div className="admin-main">
        ...
        <header className="admin-topbar">
          ...
          <div className="admin-topbar__right">
            ...
            <div 
              className="executive-profile-pill" 
            ...
            >
              ...
              <span className="executive-profile-name">
                {user?.name || "MeetVirugama"}
              </span>
            </div>
          </div>
        </header>
